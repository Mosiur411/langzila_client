    ...
    return (
        <section class=" lg:px-20 mt-96 lg:mt-0">
            <div class="px-5 py-24 mx-auto">
                ...
                <div class="flex flex-wrap -m-4 text-center overflow-hidden">
                    <div class="p-4 lg:w-1/4 md:w-1/2 w-full h-80">
                        <div class="shadow-lg border-l-4 border-l-primary px-5 py-6 rounded-lg h-[270px] overflow-hidden">
                    ...
                    <div class="p-4 lg:w-1/4 md:w-1/2 sm:w-1/2 w-full">
                        <div class="shadow-lg border-l-4 border-l-primary rounded-lg px-5 py-6 h-[270px] overflow-hidden">
