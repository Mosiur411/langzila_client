...
<div className='flex gap-5 container items-center  mx-auto'>
 <div className='flex-none lg:w-48 sm:w-14 pl-5 '>
 <div className='mt-3 flex flex-col items-center  justify-center '>
  <h1 className='text-black text-xs lg:text-xl font-bold mt-2 text-center '>{data?.name}</h1>
    <img className='w-14 lg:w-24 rounded-full  border-orange-500 border-2 ' src={data?.profileimg}
     alt="" />
     <p className='text-xs lg:text-xl text-center'>Member</p>
 ...
 <div className='flex justify-center items-center w-48 sm:w-'>
