                    ...
                    <div className=' w-[40%] text-center'>
                        ...
                        <div data-aos="fade-down-right">
                            ...
                            <div className=' w-full text-center mt-3'>
                                <button onClick={() => navigate('/assignment/assignment1quiz')} className=' text-center mx-auto bg-purple-900 text-sm font-medium py-1 px-3 rounded text-white'>Start Assignment</button>
                            </div>
                        </div>
                    </div>
                    <div className=' w-[60%]'>
