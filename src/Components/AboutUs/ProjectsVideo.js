    ...
    return (
        <div className='relative'>
            <div className='w-full mx-auto'>
                ...
                <ReactPlayer width={widthhynakan ? "300px" : "700px"}
                    className="absolute top-0 left-0 right-0 bottom-0  mx-auto" controls url='https://www.youtube.com/watch?v=ysz5S6PUM-U' />
                <div>
