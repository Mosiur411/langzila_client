                ...
                <div className='w-[300px] h-[250px] mx-auto'>
                    <div className='relative'>
                        ...
                        <svg className='absolute top-36' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                            <path fill="#ffffff" fill-opacity="1" d="M0,192L21.8,208C43.6,224,87,256,131,240C174.5,224,218,160,262,117.3C305.5,75,349,53,393,58.7C436.4,64,480,96,524,138.7C567.3,181,611,235,655,234.7C698.2,235,742,181,785,149.3C829.1,117,873,107,916,101.3C960,96,1004,96,1047,117.3C1090.9,139,1135,181,1178,192C1221.8,203,1265,181,1309,165.3C1352.7,149,1396,139,1418,133.3L1440,128L1440,320L1418.2,320C1396.4,320,1353,320,1309,320C1265.5,320,1222,320,1178,320C1134.5,320,1091,320,1047,320C1003.6,320,960,320,916,320C872.7,320,829,320,785,320C741.8,320,698,320,655,320C610.9,320,567,320,524,320C480,320,436,320,393,320C349.1,320,305,320,262,320C218.2,320,175,320,131,320C87.3,320,44,320,22,320L0,320Z"></path>
                        </svg>
                    </div>
