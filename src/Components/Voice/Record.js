...
const Record = () => {
  ...
  return (
    <div>
       <div className='w-[100%] border border-2 border-primary rounded mx-auto px-10 shadow-lg h-[50vh] flex items-center'>
     {
      ...
      {/* <button className='btn btn-primary mx-5' onClick={handleStart}>Start</button> */}
