...
// Audio
import Audio1 from '../../../../assets/QuizImg/HindiAudio/क1.mp3'
import Audio2 from '../../../../assets/QuizImg/HindiAudio/ख2.mp3'
import Audio3 from '../../../../assets/QuizImg/HindiAudio/ग3.mp3'
import Audio4 from '../../../../assets/QuizImg/HindiAudio/घ4.mp3'
import Audio5 from '../../../../assets/QuizImg/HindiAudio/ङ5.mp3'
import Audio6 from '../../../../assets/QuizImg/HindiAudio/च6.mp3'
import Audio7 from '../../../../assets/QuizImg/HindiAudio/छ7.mp3'
import Audio8 from '../../../../assets/QuizImg/HindiAudio/ज8.mp3'
import Audio9 from '../../../../assets/QuizImg/HindiAudio/झ9.mp3'
import Audio10 from '../../../../assets/QuizImg/HindiAudio/ञ10.mp3'
...
const HindiMediumQ1 = () => {
    ...
    // Get Quiz Ans Data
    useEffect(() => {
        fetch(`https://langzila.herokuapp.com/hindiMediumQAns1/${email}`, {
            method: 'GET'
        })
            .then(res => res.json())
            .then(data => {
    ...
    const selectAnswer = async (quizAns, quz, Allans, isData) => {
        ...
        if (!isData) {
            ...
            if (QuizData) {
                try {
                    const { data } = await axios.post(`https://langzila.herokuapp.com/hindiMediumQ1`, QuizData, {
                        method: 'POST'
                    });
