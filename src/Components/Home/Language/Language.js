  ...
  return (
    <div className="xl:px-10 py-10 bg-secondary text-center ">
      <div>
        ...
        <p className=" xl:w-1/3 w-3/4 mx-auto text-gray-600">
      ...
      <div className="mx-auto mt-20  ">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 ">
          <div
            data-aos="fade-right"
            className=" bg-white relative rounded-lg shadow-lg w-[300px]  mb-20 mx-auto"
          >
            <h1 className=" text-sm font-semibold text-gray-500 font-mono absolute left-3 top-3">
              L A N G U A G E
            </h1>
            <div className=" relative ">
              <div className="relative">
                ...
                <img
                  ...
                  src="https://themes.envytheme.com/ecademy/wp-content/themes/ecademy/assets/img/shape-style1.png"
                  alt=""
                />
              </div>
            ...
            <h1 className=" text-xl font-mono text-blue-700 font-medium">
              Bangla Language
            </h1>
            <button
              onClick={() => navigate("/bangla/easy")}
              id="#start"
              style={{ fontFamily: "Nunito" }}
              className=" px-4 py-1  bg-red-500 rounded font-medium text-white text-md mt-2 mb-12"
            >
              Start Now
            </button>
          </div>
          ...
          >
            ...
            <button
              onClick={() => navigate("/hindi/hindieasy")}
              style={{ fontFamily: "Nunito" }}
              className=" px-4 py-1  bg-red-500 rounded font-medium text-white text-md mt-2 mb-12"
            >
              Start Now
          ...
          >
            ...
            <button
              onClick={() => navigate("/english/englisheasy")}
              style={{ fontFamily: "Nunito" }}
              className=" px-4 py-1  bg-red-500 rounded font-medium text-white text-md mt-2 mb-12"
            >
              Start Now
