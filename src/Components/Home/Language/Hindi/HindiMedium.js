            ...
            <div className=' pt-10 grid xl:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-10 justify-center'>
                ...
                <div className=' h-40 w-[80] bg-sky-400 shadow rounded-md flex items-center overflow-hidden'>
                    <div className=' w-full'>
                        ...
                        <button onClick={() => navigate('/hindimedium/mediumquiz1')} className=' py-[5px] px-4 rounded-3xl text-black border border-white bg-white hover:border hover:border-black hover:bg-transparent  text-md font-semibold mt-3 '>Start Now</button>
                    </div>
                ...
                <div className=' h-40 w-[80] bg-sky-400 shadow rounded-md flex items-center overflow-hidden'>
                    <div className=' w-full'>
                        ...
                        <button onClick={() => navigate('/hindimedium/mediumquiz2')} className=' py-[5px] px-4 rounded-3xl text-black border border-white bg-white hover:border hover:border-black hover:bg-transparent  text-md font-semibold mt-3 '>Start Now</button>
                    </div>
                    <img className=' w-[180px] h-full mt-7' src={Quizimg} alt="Quizimg" />
                </div>
                ...
                <div className=' h-40 w-[80] bg-sky-400 shadow rounded-md flex items-center overflow-hidden'>
                    <div className=' w-full'>
                        ...
                        <button onClick={() => navigate('/hindimedium/mediumquiz3')} className=' py-[5px] px-4 rounded-3xl text-black border border-white bg-white hover:border hover:border-black hover:bg-transparent  text-md font-semibold mt-3 '>Start Now</button>
                    </div>
                    <img className=' w-[180px] h-full mt-7' src={Quizimg} alt="Quizimg" />
                </div>
                ...
                <div className=' h-40 w-[80] bg-sky-400 shadow rounded-md flex items-center overflow-hidden'>
                    <div className=' w-full'>
                        ...
                        <button onClick={() => navigate('/hindimedium/mediumquiz4')} className=' py-[5px] px-4 rounded-3xl text-black border border-white bg-white hover:border hover:border-black hover:bg-transparent  text-md font-semibold mt-3 '>Start Now</button>
                    </div>
                    <img className=' w-[180px] h-full mt-7' src={Quizimg} alt="Quizimg" />
                </div>
                ...
                <div className=' h-40 w-[80] bg-sky-400 shadow rounded-md flex items-center overflow-hidden relative'>
                    <div className=' w-full'>
