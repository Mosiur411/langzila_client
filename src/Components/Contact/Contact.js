...
const Contact = ({ show, setShow }) => {
  const sendEmail = (event) => {
    ...
    toast.success(
      "Your submission has been received. I'll get back to you very soon.",
      {
  ...
  return (
    <>
      ...
      <div className="w-5/6 mx-auto mb-12">
        <h2 className="text-4xl font-bold text-accent text-center py-8">
          Contact Us
        </h2>
        <p className="text-center lg:w-[800px] mb-5 mx-auto">
          Need to get in touch with us? Enter fill out the form with your
          inquiry.
        </p>
        <div className="md:flex lg:flex justify-center items-center">
          <div className="md:w-3/5 lg:w-3/5">
            ...
            <h2 className="text-4xl font-bold text-accent py-2">
              Get in Touch
            </h2>
          ...
          <div className="md:w-2/5 lg:w-2/5 rounded-md shadow-lg border-l-4 border-l-primary p-8">
            <h2 className="text-3xl py-2 font-bold text-accent">
